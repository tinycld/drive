...
const FILES: {
    ...
    {
        name: 'Meeting Notes - All Hands.docx',
        folder: null,
        shared: true,
        starred: false,
        description: '',
    ...
    {
        name: 'Passwords (DO NOT SHARE).txt',
        folder: null,
        shared: false,
        starred: false,
        description: '',
    ...
    {
        name: 'Team Photo - Summer Offsite.jpg',
        folder: null,
        shared: true,
        starred: true,
        description: '',
    ...
    {
        name: 'Source Code Snapshot.tar.gz',
        folder: null,
        shared: false,
        starred: false,
        description: '',
    ...
    {
        name: 'Server Configuration.json',
        folder: null,
        shared: false,
        starred: false,
        description: '',
    ...
    {
        name: 'API Tokens (rotate quarterly).json',
        folder: null,
        shared: false,
        starred: false,
        description: '',
    ...
    {
        name: 'Voice Memo - Brainstorm.mp3',
        folder: null,
        shared: false,
        starred: false,
        description: '',
    ...
    {
        name: 'Performance Review (Self).docx',
        folder: null,
        shared: false,
        starred: false,
        description: '',
    ...
    {
        name: 'Interview Loop - Engineering.docx',
        folder: null,
        shared: true,
        starred: false,
        description: '',
